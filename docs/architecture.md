...
Cards travel between machines through **git** (the `data/` partitions) and through
**AnkiWeb** (the Anki collection); the SQLite DB and `media/` stay local. Four
