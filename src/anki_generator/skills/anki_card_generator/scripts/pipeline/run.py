...
from anki_generator.skills.anki_card_generator.scripts.schemas import CmdRunResponse, DbInsertResult, BackupResult
...
from .core import (
    ...
    _route_listening, ANKI_LISTENING_DECK
)
...
def cmd_run(file_path, deck_name, db_path=None) -> tuple[CmdRunResponse, int]:
    ...
    # Dynamically read ANKI_ENABLED config for monkeypatching support
